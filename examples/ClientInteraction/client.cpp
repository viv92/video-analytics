...
int main(int argc, char* argv[])
{
    try {
        if (argc < 6) {
            std::cerr << "Usage: ./client [host] [port] [filename] [aiSaacSettingsPath] [resultTableId] [caSettingsFilePath] [resultTableFeature] [isCropped(optional)]\n";
            return 1;
        }
        ...
        std::string terminating_message = "finished";
        while(1) {
