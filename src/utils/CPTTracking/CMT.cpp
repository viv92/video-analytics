...
void CMT::initialize(const Mat im_gray, const Rect rect)
{
    ...
    initial_active_points = points_active.size();
...
void CMT::processFrame(Mat im_gray) {
    ...
    //std::cout <<  "CMT::processFrame() call" << std::endl << std::flush;
    //Track keypoints
    ...
    //std::cout << "before calling detector" << std::endl;
    //Detect keypoints, compute descriptors
    vector<KeyPoint> keypoints;
    detector->detect(im_gray, keypoints);
    //std::cout << "detection complete" << std::endl << std::flush;
    //FILE_LOG(logDEBUG) << keypoints.size() << " keypoints found.";

    Mat descriptors;
    descriptor->compute(im_gray, keypoints, descriptors);
    //std::cout << "compute complete" << std::endl << std::flush;
    ...
    //std::cout << "matcher complete" << std::endl << std::flush;
    ...
    //std::cout << "fuse complete" << std::endl << std::flush;
    ...
    //std::cout << "estimate scale complete" << std::endl << std::flush;
    ...
    //std::cout << "find consensus complete" << std::endl << std::flush;
    ...
    //std::cout << "match local complete" << std::endl << std::flush;
...
//    classes_active = classes_fused;
    ...
    //std::cout << "CMT::processFrame() return" << std::endl << std::flush;
}
