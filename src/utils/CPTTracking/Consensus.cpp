        ...
        Point2f & center, vector<Point2f> & points_inlier, vector<int> & classes_inlier)
{
    ...
    //std::cout << "points not 0" << std::endl << std::flush;
    //Compute votes
    ...
    //std::cout << "In consensus for 1 complete" << std::endl << std::flush;
    ...
    //std::cout << "comparing pairwise distance start" << std::endl << std::flush;
    int index = 0;
    for (size_t i = 0; i < points.size(); i++)
    {
    ...
    //std::cout << "comparing pairwise distance stop" << std::endl << std::flush;
    //FILE_LOG(logDEBUG) << "Consensus::MST_linkage_core() call";
    //std::cout << "Consensus::MST_linkage_core() call" << std::endl << std::flush;
    MST_linkage_core(N,D,Z);
    //FILE_LOG(logDEBUG) << "Consensus::MST_linkage_core() return";
    //std::cout << "Consensus::MST_linkage_core() return" << std::endl << std::flush;
    ...
    //FILE_LOG(logDEBUG) << "Consensus::findConsensus() return";
    //std::cout << "Consensus::findConsensus() return" << std::endl << std::flush;
}
