...
int main(int argc, char** argv){
	...
	Vector g;
	cout<<"*******************************************************************\n";
	cout<<"Testing Gradient Descent with L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"Testing Gradient Descent with Line Search for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"Testing Gradient Descent with Barzilia-Borwein Step Length for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"Testing Nesterov's Method for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"Testing Conjugate Gradient for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"L-BFGS for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"L-BFGS-Owl for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"Stochastic Gradient Descent for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"Stochastic Gradient Descent with Decaying Learning Rate for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
	...
	cout<<"*******************************************************************\n";
	cout<<"Stochastic Gradient Descent with AdaGrad for L1-Smooth SVM Loss, press enter to continue...\n";
	#ifndef DEBUG
	cin.get();
	#endif
