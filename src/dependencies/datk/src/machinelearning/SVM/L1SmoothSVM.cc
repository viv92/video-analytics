...
#include "../../optimization/contFunctions/L1SmoothSVMLoss.h"
...
// save the model
template <class Feature>
int L1SmoothSVM<Feature>::saveModel(const char* model){
...
template <class Feature>
int L1SmoothSVM<Feature>::saveJsonModel(const char* model){
...
template <class Feature>
int L1SmoothSVM<Feature>::loadModel(const char* model){
...
template <class Feature>
int L1SmoothSVM<Feature>::loadJsonModel(const char* model){
