...
namespace cmtk {
  template <class Feature>
	class ProbitLoss: public ContinuousFunctions{
	protected:
	...
	public:
		ProbitLoss(int numFeatures, std::vector<Feature>& features, Vector& y);
        ProbitLoss(const ProbitLoss& c); // copy constructor
