...
FacilityLocation::FacilityLocation(int n, const std::vector<std::vector <float> >& kernel) : SubmodularFunctions(n), kernel(kernel), sizepreCompute(2*n){
...
FacilityLocation::FacilityLocation(const FacilityLocation & f) : SubmodularFunctions(f), kernel(f.kernel), sizepreCompute(f.sizepreCompute) {
