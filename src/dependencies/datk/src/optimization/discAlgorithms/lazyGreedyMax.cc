...
void lazyGreedyMax(const SubmodularFunctions& f, double budget, Set& greedySet, int verbosity, bool precomputeSet, bool equalityConstraint, Set groundSet, bool grSetn)
{
