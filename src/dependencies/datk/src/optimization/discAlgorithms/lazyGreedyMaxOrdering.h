 ...
 *
 */
#ifndef LAZY_GREEDY_ORDERING_H
#define LAZY_GREEDY_ORDERING_H
...
namespace datk {
	...
	void lazyGreedyMaxOrdering(const SubmodularFunctions& f, Set& greedySet, std::vector<int>& greedyOrdering, int verbosity = 1, bool precomputeSet = false,
