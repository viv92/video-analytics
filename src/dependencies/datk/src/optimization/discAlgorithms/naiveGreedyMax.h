 ...
 *
 */
#ifndef __NAIVE_GREEDY_MAX_h
#define __NAIVE_GREEDY_MAX_h
...
void naiveGreedyMax(SetFunctions& f, double budget, Set& greedySet, int verbosity = 1, bool precomputeSet = false,
bool isEquality = false, Set groundSet = Set(), bool grSetn = true);
