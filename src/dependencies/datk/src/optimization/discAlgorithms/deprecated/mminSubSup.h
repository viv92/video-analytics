 ...
 *
 */
#ifndef SMTK_MMINSubSup_INCLUDED
#define SMTK_MMINSubSup_INCLUDED
...
void mminSubSup(SubmodularFunctions& f, SubmodularFunctions& g, Container& currset, double lambda, int verbosity, bool mode, Container startSet = Container());

extern template void mminSubSup(SubmodularFunctions& f, SubmodularFunctions& g, HashSet& currset, double lambda, int verbosity, bool mode, HashSet startSet = HashSet());
